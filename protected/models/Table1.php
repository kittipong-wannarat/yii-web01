 ...
 *
 * The followings are the available columns in table 'table1':
 * @property integer $id
...
class Table1 extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('field1, field2', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, field1, field2', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Table1 the static model class
	 */
